...
public class RegisterPage extends JFrame {
	...
	/**
	 * this page is to register as a receiver , considering all the errors that can occur.
	 * this frame use the method AddReceiver from sysdata .
	 */
	public RegisterPage() {
		...
		registerButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				else if(!SysData.getInstance().doesEmailExist(textField_3.getText())) {
					emailLabel.setVisible(true);
					emailLabel.setText("Email does exist");
				}
